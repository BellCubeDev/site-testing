...
const possibilities_conditionalized:[conditionObj, string][] = [
    ...
    [ {time: [[3,0], [11,59]]}, "&rsquo;Mornin! Nice day for fishin&rsquo;, ain&rsquo; it?" ],
...
const possibilities_Generic = [
    ...
    "I don&rsquo; know if the LOOT admins love me or are annoyed with me.",
    ...
    "&rsquo;is a wicked axe you wield there, friend. That blade looks sharp enough to cut through a god.",
    ...
    "Don&rsquo; suppose you&rsquo;d enchant my sword? Dull old blade can barely cut butter.",
    ...
    "I am a part of you, little mortal. I am a shadow in your subconscious, a blemish on your fragile little psyche. You know me. You just don&rsquo; know it.",
    "Now that&rsquo;s the real question, isn&rsquo; it? Because honestly, how much time off could a demented Daedra really need?",
    ...
    "The Wabbajack! Huh? Huh? Didn&rsquo; see that coming, did you?",
    ...
    "You have proven yourself worthy of the next world.", // Copilot&rsquo;s on FIRE today!
    "You once told me you did not believe in destiny.",
    ...
    "They&rsquo;re all dead. You don&rsquo; want to join them, do you?",
    ...
    "My hard drive is reading over 30 MB/s at idle and I'm scared.",
